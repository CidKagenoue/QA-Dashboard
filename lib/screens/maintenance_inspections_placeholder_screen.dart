// lib/screens/onderhoud_keuringen_screen.dart
import 'package:flutter/material.dart';

class MaintenanceInspectionsPlaceholderScreen extends StatelessWidget {
  const MaintenanceInspectionsPlaceholderScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ModulePlaceholder(
      moduleName: 'Onderhoud & Keuringen',
      icon: Icons.build_outlined,
      description:
          'De module Onderhoud & Keuringen is momenteel in ontwikkeling. '
          'Hier zal je onderhoudstaken en keuringen kunnen plannen en opvolgen.',
    );
  }
}
