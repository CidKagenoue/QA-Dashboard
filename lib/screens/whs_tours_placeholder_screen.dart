// lib/screens/whs_tours_screen.dart
import 'package:flutter/material.dart';

class WhsToursScreen extends StatelessWidget {
  const WhsToursScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ModulePlaceholder(
      moduleName: 'WHS-Tours',
      icon: Icons.apartment_outlined,
      description:
          'De WHS-Tours module is momenteel in ontwikkeling. '
          'Hier zal je weldra rondleidingen en inspecties kunnen beheren.',
    );
  }
}
